 ...
 * 
 */
package com.pointlion.sys.mvc.admin.applog;
...
import com.pointlion.sys.mvc.common.model.SysApplog;
...
public class AppLogController extends BaseController{
	...
	public void getListPage(){
    	render("/WEB-INF/admin/applog/list.html");
    }
    /***
     * 获取编辑页面
     */
    ...
    *//***
    ...
    public void listData(){
    	...
    	Page<SysApplog> page = SysApplog.dao.getAppLogPage(Integer.valueOf(curr),Integer.valueOf(pageSize));
    ...
    public void delete() throws Exception{
    	SysApplog.dao.deleteByIds(getPara("ids"));
    	renderSuccess();
    }
