package com.pointlion.sys.mvc.admin.im;
...
public class InformationmManagementController extends BaseController {
	...
	public void getImList(){
		render("/WEB-INF/admin/im/list.html");
	}
    ...
    /**************************************************************************/
    private String pageTitle = "信息上传";//模块页面标题
	private String breadHomeMethod = "getImList";//面包屑首页方法
